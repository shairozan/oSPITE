...
@section('content')
    ...
    <form id="newWeapon" class="newWeapon" method="post" action="{{ action('TimesController@store') }}" class="form-horizontal" enctype="multipart/form-data">
    {!! csrf_field() !!}
    ...
    <script>
        $("#newWeapon").validate({
            ...
            messages: {
                name:{
                    required: "Please enter a name for the epoch",
