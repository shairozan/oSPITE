        ...
        <div class="col-md-6 ">
            <div class="card">
                <div class="card-image">
                    <img src="{{$time->image or asset('images/vector/person.svg')}}" style="max-height:100%;max-width:100%;" />
        ...
        <div class="col-md-6" >
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <a href="{{action('RelationshipsController@map',['source_class'=>'App\\Time'
                    ,'source_id'=>$time->id])}}" class="btn btn-xs purple waves-effect waves-light">Add a Relationship</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <ul id="projects-collection" class="collection">
                ...
                <li>
                    ...
                    <ul class="collapsible popout collapsible-accordion" data-collapsible="accordion">
                        ...
                        @foreach($time->getRelations() as $relationship)
