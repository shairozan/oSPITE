...
@section('content')
    ...
    <form id="newWeapon" class="newWeapon" method="post" action="{{ action('WeaponsController@store') }}" class="form-horizontal" enctype="multipart/form-data">
    {!! csrf_field() !!}
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <div class="input-field">
                <input placeholder="Weapon Name" id="name" name="name" type="text" class="validate">
                <label for="first_name">Weapon Name <span class="required">*</span> </label>
            </div>

            <div class="input-field">
                <input placeholder="Weapon Type (IE Dagger)" id="type" name="type" type="text">
                <label for="type">Type <span class="required">*</span></label>
            </div>

            <div class="input-field">
                <input placeholder="Number of Die" id="die_quantity" name="die_quantity" type="text" class="validate">
                <label for="die_quantity">Die Number <span class="required">*</span></label>
            </div>

            <div class="input-field">
                <input placeholder="Die sides" id="die_sides" name="die_sides" type="text" class="validate">
